...
import { generatePassword, randomNickname, decryptSafeLink, safariIOSFix } from './utils';
...
function setupSSE () {
    ...
    source.addEventListener('error', async function (err) {
        ...
        if (SSErefreshCounter > 99) {
            ...
            return console.log(`${ts} Tried 100 reconnections, no success please refresh`);
        }
