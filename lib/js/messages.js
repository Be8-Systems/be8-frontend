...
import { isPhone, mockupPartner, icons, domCache } from './data.js';
...
class Messages extends LitElement {
    ...
    renderConversationPartner () {
        ...
        const name = html`<p>${this.conversationPartner.nickname} #${this.conversationPartner.id}</p>`;
    ...
    renderWriteContainer () {
        return html`<div class="write-container"><input type="text"><div><i class="fa-solid fa-photo-film"></i></div></div>`;
    }
