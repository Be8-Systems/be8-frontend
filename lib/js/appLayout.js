...
class AppLayout extends LitElement {
    ...
    openWelcomeWindow ({ id }) {
        return this.#modal.setAndOpen({ HTML: `<h1>Welcome to Be8</h1><p>your new ID is <strong>#${id}</strong>. Everything gets deleted after 30 Days you can create as many accs as you want.</p>` });
    }
