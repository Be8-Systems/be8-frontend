export default Object.freeze({
    ...
    STARTCONVERSATION: 'Start conversation at {{ts}} with <i class="highlight-color">#{{conversationID}}</i>',
    CREATEDGROUP: 'You created a new group with the id {{extra1}} and name {{extra2}} on {{ts}}.'
});