...
class User extends LitElement {
    ...
    render () {
        ...
        const endlessToken = html`<div class="settings-container"><p>Endless Token</p><input type="text" maxlength="${tokenLength}"><button @click="${this.clickOnEndlessToken}">Check</button></div>`;
