...
class Modal extends LitElement {
    ...
    render (content = '', sideContent = '') {
        ...
        return html`<div class="inner-modal" @mouseenter="${this.#mouseEnter}" @mouseleave="${this.#mouseLeave}">${close}<div class="modal-content">${content}</div><div class="modal-side">${sideContent}</div></div>`;
    }
}
