...
class Modal extends LitElement {
    ...
    render (content = '', sideContent = '') {
        return html`<div class="inner-modal"><small @click="${this.close}" class="close-modal unselectable">close</small><div class="modal-content">${content}</div><div class="modal-side">${sideContent}</div></div>`;
    }
}
