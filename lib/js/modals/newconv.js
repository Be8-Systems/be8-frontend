...
class ConversationModal extends Modal {
    ...
    render () {
        const content = html`<p>${LANG.CONVERSATION}</p><input @keydown="${(e) => this.#keyDownOn1to1(e)}" tabindex="0" type="number"><div @click="${this.#clickOnGoToGroup}" class="sub-modal-button hover-background">Create a group <i class="fa-solid fa-arrow-right float-right"></i></div>`;
