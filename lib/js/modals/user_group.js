...
class GroupUsermodal extends Modal {
    ...
    #renderSiderGroup (amIAdmin) {
        ...
        const addUser = html`<div class="adduser-group-modal hide"><p class="create-group-headline">${backToMain} Add new Member</p><small></small></div>`;
        const leaveText = amIAdmin ? LANG.LEAVEGROUPADMIN : LANG.LEAVEGROUPMEMBER;
        const leaveGroup = html`<div class="leave-group-modal hide"><p class="create-group-headline">${backToMain} Leave Group</p><small>${leaveText}</small></div>`;
