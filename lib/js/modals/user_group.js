...
class GroupUsermodal extends Modal {
    ...
    #renderSiderGroup (amIAdmin) {
        ...
        const leaveGroup = html`<div class="leave-group-modal hide"><p class="create-group-headline">${backToMain} Leave Group</p><small>${leaveText}</small><div><button>Yes</button><button>No</button></div></div>`;
