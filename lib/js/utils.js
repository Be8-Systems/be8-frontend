...
export function safariIOSFix () {
    ...
    if (!isPWA && isPhone) {
        ...
        document.querySelector('app-layout').addEventListener('resize', function () {
            console.log('app-layout');
            console.log(window.innerHeight);
        });
        document.querySelector('messages-menu').addEventListener('resize', function () {
