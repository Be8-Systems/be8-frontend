...
class AppLayout extends LitElement {
    ...
    render () {
        ...
        const menus = html`<messages-menu @touchstart="${e => this.#touchStart(e)}" @touchend="${e => this.#touchEnd(e)}" class="${isPhone ? 'hide' : ''}"></messages-menu><settings-menu class="hide"></settings-menu><user-menu class="hide"></user-menu>`; 
