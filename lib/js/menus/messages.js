...
class Messages extends LitElement {
    ...
    #renderMessageContent (message, timeIndicator) {
        if (message.messageType === 'image') {
            return html`<i class="fa-solid fa-spin fa-circle-notch"></i><img height="${message.imgHeight}" width="${message.imgWidth}" data-contentid="${message.contentID}" data-rendered="false" src=""><p>${timeIndicator}</p>`;
        }
