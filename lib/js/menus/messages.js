...
class Messages extends LitElement {
    ...
    renderConversationPartner () {
        ...
        const name = html`<p @click="${this.clickOnUser}" class="font-hover">${icon} ${this.conversationPartner.nickname} ${idIndicator}</p> `;
        ...
        return html`<div class="conversation-partner hover-font">${back}${user}</div>`;
    }
