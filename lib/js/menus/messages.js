...
class Messages extends LitElement {
    ...
    #renderMessageContent (message, timeIndicator) {
        if (message.messageType === 'image') {
            return html`<a href="" download="${message.contentID}.png"><i class="fa-solid fa-spin fa-circle-notch"></i><img download="${message.contentID}" style="height:500px" data-contentid="${message.contentID}" data-rendered="false" src=""><p>${timeIndicator}</p></a>`;
        }
    ...
    #getNicknameLine (message) {
        ...
        const endlessIcon = message.endless ? html`<i class="fa-solid fa-check danger-color"></i>` : '';
