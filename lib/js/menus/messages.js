...
class Messages extends LitElement {
    ...
    #renderMessageContent (message, timeIndicator) {
        if (message.messageType === 'image') {
            return html`<i class="fa-solid fa-spin fa-circle-notch"></i><img data-contentid="${message.contentID}" data-rendered="false" src=""><p>${timeIndicator}</p>`;
        }
    ...
    #renderRemoveMessage ({ sender }) {
        ...
        return html`<div class="message-container"><div class="message ${amIsender ? 'sent-message' : 'received-message'}"><i class="fa-solid fa-trash-can"></i>${lang.MESSAGEREMOVED}</div></div>`; 
    }
