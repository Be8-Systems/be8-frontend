...
class Messages extends LitElement {
    ...
    writeMessage (e) {
        if (e.key === 'Enter') {
            ...
            const receiver =  this.conversationPartner.id || this.conversationPartner.groupID ||  this.conversationPartner.channelID;
    ...
    #renderRemoveMessage () {
        return html`<div class="message-container"><div class="message received-message">${lang.MESSAGEREMOVED}</div></div>`; 
    }
